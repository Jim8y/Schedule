...
- (void)setupToolbar
{
    ComposeToolbar *toolbar1 = [[ComposeToolbar alloc] init];
    toolbar1.width = self.view.width;
    toolbar1.height = 44;
    toolbar1.y = self.view.height - toolbar1.height;
...
- (void)setupNav
{
    ...
    NSString *name = @"hahhaha";//[AccountTool account].name;
    NSString *prefix = @"发微博";
    if (name) {
